...
DATABASES = {
    'default': {
        ...
        'NAME': 'sqlite-base.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'h0l(l_^kio3@7qa--jduf77g!lcf7&5nxx#s(h1gl7)hddr#61'
...
ROOT_URLCONF = 'aspectometer.urls'
